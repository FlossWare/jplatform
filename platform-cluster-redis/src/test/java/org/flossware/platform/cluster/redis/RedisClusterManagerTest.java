...
class RedisClusterManagerTest {
  ...
  void testConstructorNullConfig() {
    assertThrows(IllegalArgumentException.class, () -> new RedisClusterManager(null));
  }

  @Test
  void testConstructorWithPoolNullConfig() {
    assertThrows(IllegalArgumentException.class, () -> new RedisClusterManager(null, mockPool));
  }
