...
/**
 * Redis-based implementation of ClusterStateStore. Stores distributed application state and
 * descriptors using Redis hashes.
 *
 * <p>This implementation uses:
 *
 * <ul>
 *   <li>Redis hashes for storing application states
 *   <li>Redis hashes for storing application descriptors
 *   <li>JSON serialization for complex objects
 *   <li>Local caching for read performance
 * </ul>
 *
