...
/**
 * Configuration for Redis-based clustering. Provides connection settings for Redis server and lease
 * parameters.
 *
 * <p>Example usage:
 *
...
public class RedisConfig {
  ...
  /** Builder for RedisConfig instances. Provides a fluent API for configuration. */
