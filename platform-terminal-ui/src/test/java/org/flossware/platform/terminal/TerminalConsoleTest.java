...
/**
 * Unit tests for TerminalConsole. Tests API contract and validation.
 *
 * <p>Note: Full terminal UI testing requires a TTY environment and is not feasible in headless
 * CI/CD. These tests focus on API validation and constructor behavior.
 */
