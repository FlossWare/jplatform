...
class JmsConfigTest {
  ...
  void testBuilder_withDefaults() {
    JmsConfig config = JmsConfig.builder().brokerUrl("tcp://localhost:61616").build();
  ...
  void testBuilder_onlyBrokerUrl() {
    JmsConfig config = JmsConfig.builder().brokerUrl("vm://localhost").build();
  ...
  void testBuilder_builderReuse() {
    JmsConfig.Builder builder =
        JmsConfig.builder().brokerUrl("tcp://localhost:61616").username("user1");
  ...
  void testBuilder_acknowledgeModeBoundaryValues() {
    JmsConfig config1 =
        JmsConfig.builder().brokerUrl("tcp://localhost:61616").acknowledgeMode(0).build();
  ...
  void testBuilder_transactedToggle() {
    JmsConfig.Builder builder = JmsConfig.builder().brokerUrl("tcp://localhost:61616");
