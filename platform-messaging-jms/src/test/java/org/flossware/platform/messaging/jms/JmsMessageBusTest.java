...
class JmsMessageBusTest {
  ...
  void setUp() throws JMSException {
    ...
    when(connection.createSession(anyBoolean(), anyInt()))
        .thenReturn(publishSession, subscribeSession);
  }
  ...
  void testConstructor_withoutAuthentication() throws JMSException {
    JmsConfig noAuthConfig = JmsConfig.builder().brokerUrl("tcp://localhost:61616").build();
  ...
  void testConstructor_nullConfig() {
    assertThrows(NullPointerException.class, () -> new JmsMessageBus(null, connectionFactory));
  }

  @Test
  void testConstructor_nullConnectionFactory() {
    assertThrows(NullPointerException.class, () -> new JmsMessageBus(config, null));
  }
  ...
  void testConstructor_connectionFailure() throws JMSException {
    ...
    assertThrows(JMSException.class, () -> new JmsMessageBus(config, connectionFactory));
  }
  ...
  void testPublish_nullTopic() throws JMSException {
    ...
    assertThrows(NullPointerException.class, () -> messageBus.publish(null, message));
  }
  ...
  void testPublish_nullMessage() throws JMSException {
    ...
    assertThrows(NullPointerException.class, () -> messageBus.publish("test-topic", null));
  }
  ...
  void testPublish_whenClosed() throws JMSException {
    ...
    assertThrows(
        java.lang.IllegalStateException.class, () -> messageBus.publish("test-topic", message));
  }
  ...
  void testPublish_jmsException() throws JMSException {
    ...
    assertThrows(RuntimeException.class, () -> messageBus.publish("test-topic", message));
  }
  ...
  void testPublish_withNullPayload() throws JMSException {
    ...
    Message message =
        Message.builder().topic("test-topic").sourceApplicationId("test-app").payload(null).build();
  ...
  void testSubscribe_nullTopic() throws JMSException {
    ...
    assertThrows(NullPointerException.class, () -> messageBus.subscribe(null, handler));
  }
  ...
  void testSubscribe_nullHandler() throws JMSException {
    ...
    assertThrows(NullPointerException.class, () -> messageBus.subscribe("test-topic", null));
  }
  ...
  void testSubscribe_whenClosed() throws JMSException {
    ...
    assertThrows(
        java.lang.IllegalStateException.class, () -> messageBus.subscribe("test-topic", handler));
  }
  ...
  void testSubscribe_jmsException() throws JMSException {
    ...
    assertThrows(RuntimeException.class, () -> messageBus.subscribe("test-topic", handler));
  }
  ...
  void testMessageHandling_deserializationFailure() throws JMSException {
    ...
    when(bytesMessage.getJMSTimestamp()).thenReturn(System.currentTimeMillis());
    when(bytesMessage.getStringProperty("sourceApplicationId")).thenReturn("test-app");
    when(bytesMessage.getObjectProperty("platformHeaders"))
        .thenReturn(new byte[] {1, 2, 3}); // Corrupted data
    when(bytesMessage.getBodyLength()).thenReturn(0L);
