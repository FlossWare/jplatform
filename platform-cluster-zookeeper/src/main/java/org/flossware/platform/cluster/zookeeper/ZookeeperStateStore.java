 ...
 * application state and descriptors using ZooKeeper znodes.
 *
 * <p>This implementation uses:
 *
 * <ul>
 *   <li>ZooKeeper znodes for storing application states
 *   <li>ZooKeeper znodes for storing application descriptors
 *   <li>JSON serialization for complex objects
 *   <li>Watchers for change notifications
 * </ul>
 *
