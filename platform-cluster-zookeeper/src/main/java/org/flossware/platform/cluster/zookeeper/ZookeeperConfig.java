...
/**
 * Configuration for ZooKeeper-based clustering. Provides connection settings for ZooKeeper ensemble
...
public class ZookeeperConfig {
  ...
  /**
   * Returns the session timeout in milliseconds. ZooKeeper will expire the session if no heartbeat
   * within this time.
   *
  ...
  /** Builder for ZookeeperConfig instances. Provides a fluent API for configuration. */
