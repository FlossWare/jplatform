...
/**
 * ZooKeeper-based ClusterManager implementation using Apache Curator. Provides clustering via
 * ZooKeeper's distributed coordination primitives.
 *
 * <p>This implementation uses:
 *
 * <ul>
 *   <li>Leader election via Curator LeaderSelector with ephemeral znodes
 *   <li>Membership tracking via ephemeral znodes
 *   <li>Distributed state storage via ZooKeeper znodes
 * </ul>
 *
      ...
      if (client == null) {
        ExponentialBackoffRetry retryPolicy =
            new ExponentialBackoffRetry(
                this.config.getBaseSleepTimeMs(), this.config.getMaxRetries());
