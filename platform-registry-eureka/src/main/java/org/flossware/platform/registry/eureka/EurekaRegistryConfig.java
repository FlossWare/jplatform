...
/**
 * Configuration for Eureka-based service registry. Provides connection settings for Netflix Eureka
 * server and service registration parameters.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class EurekaRegistryConfig {
  ...
  /**
   * Returns the application name. This is the name under which services are registered in Eureka.
   *
  ...
  /**
   * Returns the instance ID. Unique identifier for this service instance.
   *
  ...
  /**
   * Returns the renewal interval in seconds. How often to send heartbeats to Eureka.
   *
  ...
  /**
   * Returns the lease expiration duration in seconds. How long Eureka waits before removing a
   * service that stops sending heartbeats.
   *
  ...
  /** Builder for EurekaRegistryConfig instances. Provides a fluent API for configuration. */
  public static class Builder {
    ...
    public Builder addServiceUrl(String serviceUrl) {
      if (this.serviceUrls.size() == 1
          && "http://localhost:8761/eureka".equals(this.serviceUrls.get(0))) {
