...
class EurekaRegistryConfigTest {
  ...
  void testBuilderDefaults() {
    EurekaRegistryConfig config = EurekaRegistryConfig.builder().appName("test-app").build();
  ...
  void testRenewalIntervalValidation() {
    Exception exception =
        assertThrows(
            ...
            () -> {
              EurekaRegistryConfig.builder().appName("app").renewalIntervalSeconds(0).build();
            });
  ...
  void testRenewalIntervalNegative() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> {
              EurekaRegistryConfig.builder().appName("app").renewalIntervalSeconds(-5).build();
            });
    assertTrue(exception.getMessage().contains("Renewal interval"));
  }
  ...
  void testLeaseExpirationValidation() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> {
              EurekaRegistryConfig.builder().appName("app").leaseExpirationSeconds(0).build();
            });
  ...
  void testLeaseExpirationNegative() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> {
              EurekaRegistryConfig.builder().appName("app").leaseExpirationSeconds(-10).build();
            });
    assertTrue(exception.getMessage().contains("Lease expiration"));
  }
  ...
  void testEmptyAppName() {
    Exception exception =
        assertThrows(
            ...
            () -> {
              EurekaRegistryConfig.builder().appName("  ").build();
            });
  ...
  void testInstanceIdCustomization() {
    EurekaRegistryConfig config =
        EurekaRegistryConfig.builder().appName("app").instanceId("custom-instance-123").build();
