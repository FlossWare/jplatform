...
class ApplicationDescriptorJsonModuleTest {
  ...
  void testSerializeAndDeserialize_validDescriptor() throws IOException {
    ...
    assertEquals(
        originalPool.getKeepAliveTimeSeconds(), deserializedPool.getKeepAliveTimeSeconds());
  }
  ...
  void testDeserialize_missingApplicationId() {
    ...
    IOException exception =
        assertThrows(IOException.class, () -> mapper.readValue(json, ApplicationDescriptor.class));
