 ...
 * discovery, leader election, and membership management using Hazelcast IMDG.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>TCP/IP discovery with seed nodes
 *   <li>Leader election via Hazelcast CP subsystem
 *   <li>Automatic failure detection and recovery
...
public class HazelcastClusterManager implements ClusterManager {
  ...
  /**
   * Package-private constructor for testing. Allows injection of a mock HazelcastInstance.
   *
  ...
  /**
   * Joins the cluster with the specified configuration. Initializes Hazelcast, registers membership
   * listeners, and attempts leader election.
   *
  ...
  /**
   * Leaves the cluster gracefully. Releases leader lock if held and shuts down Hazelcast instance.
   *
  ...
  /**
   * Checks if this node is the cluster leader. Leader election is based on acquiring a distributed
   * lock via Hazelcast CP subsystem.
   *
  ...
  /**
   * Returns the underlying Hazelcast instance. Useful for accessing Hazelcast-specific features.
   *
  ...
  /**
   * Attempts to acquire the leader lock and become the cluster leader. Uses Hazelcast CP
   * subsystem's FencedLock for distributed leader election.
   */
