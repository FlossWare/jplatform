...
/**
 * Comprehensive unit tests for DescriptorRegistry. Tests thread-safe registration, lookup, and
 * removal of descriptor-to-application ID mappings.
 */
class DescriptorRegistryTest {
  ...
  void testThreadSafety() throws InterruptedException {
    ...
    assertTrue(
        finalSize >= 0 && finalSize <= numThreads * opsPerThread,
