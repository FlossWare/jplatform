...
/**
 * Comprehensive unit tests for ApiAuthFilter. Tests API key authentication, header validation, and
 * filter behavior.
 */
class ApiAuthFilterTest {
  ...
  void testConstructorWithConfig() {
    config = ApiServerConfig.builder().port(8080).enableAuth(true).apiKey("test-key").build();
  ...
  void testDescription() {
    config = ApiServerConfig.builder().port(8080).build();
  ...
  void testDoFilterAuthDisabled() throws IOException {
    config = ApiServerConfig.builder().port(8080).enableAuth(false).build();
