...
/**
 * Comprehensive unit tests for JdkHttpApiServer. Tests server lifecycle, HTTP request/response
...
class JdkHttpApiServerTest {
  ...
  void testConstructorNullManager() {
    ApiServerConfig config = ApiServerConfig.builder().port(testPort).build();
  ...
  void testStartStopServer() throws Exception {
    ApiServerConfig config =
        ApiServerConfig.builder().port(testPort).bindAddress("127.0.0.1").build();
  ...
  void testInvalidPortThrowsException() {
    ...
    assertThrows(
        ...
        () -> {
          ApiServerConfig.builder().port(99999).build();
        });
  }
  ...
  void testCorsHeadersWithAllowedOrigins() throws Exception {
    ApiServerConfig config =
        ApiServerConfig.builder().port(testPort).addAllowedOrigin("http://localhost:3000").build();
  ...
  void testAuthenticationDisabled() throws Exception {
    ApiServerConfig config = ApiServerConfig.builder().port(testPort).enableAuth(false).build();
