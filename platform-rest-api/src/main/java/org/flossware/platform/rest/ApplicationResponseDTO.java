 ...
 * identity, state, deployment timestamp, and optional metrics.
 *
...
public class ApplicationResponseDTO {
  ...
  public ApplicationResponseDTO(
      ...
      String state,
      long deployedAt,
      ThreadPoolStatsDTO threadPoolStats,
  ...
  /**
   * Creates an application response DTO from an application context. Includes full metrics if the
    ...
    if (context.getState() == ApplicationState.RUNNING) {
      ...
      resourceMetrics =
          new ResourceMetricsDTO(
              snapshot.getCpuTimeNanos(), snapshot.getHeapUsedBytes(), snapshot.getThreadCount());
    }
