 ...
 *
 * <ul>
 *   <li>GET /api/platform/info - Platform version, uptime, JVM information
 *   <li>GET /api/health - Health check (returns 200 OK)
 * </ul>
 *
 * <p>Example responses:
 *
...
public class PlatformApiHandler implements HttpHandler {
  ...
  /**
   * Handles HTTP requests for platform endpoints. Routes requests based on path and HTTP method.
   *
  ...
  /**
   * Handles GET /api/health - health check endpoint. Returns a simple status indicating the server
   * is running.
   *
   * @param exchange the HTTP exchange
   * @throws IOException if an I/O error occurs
  ...
  /**
   * Handles GET /api/platform/info - platform information endpoint. Returns platform version,
   * uptime, and JVM details.
   *
   * @param exchange the HTTP exchange
   * @throws IOException if an I/O error occurs
   */
