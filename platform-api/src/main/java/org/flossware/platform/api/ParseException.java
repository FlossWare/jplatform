...
/**
 * Exception thrown when parsing an ApplicationDescriptor fails. This can occur due to invalid
 * syntax, missing required fields, or incompatible configuration values.
 *
