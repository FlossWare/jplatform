 ...
 *
 * <p>Volumes provide isolated directory storage that can persist across application restarts and
 * redeployments. Each volume has a name, mount path, persistence flag, and optional size limit.
 *
 * <p>Usage example:
 *
 * <pre>{@code
