...
/**
 * Thrown when an application fails to stop gracefully. This exception indicates that the
 * application's stop() method failed, or that the platform could not transition the application to
 * STOPPED state.
 *
 * @since 1.2
 */
