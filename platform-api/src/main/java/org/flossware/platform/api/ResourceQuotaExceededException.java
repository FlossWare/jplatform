...
/**
 * Exception thrown when an application exceeds its resource quota. This is a runtime exception to
 * allow quota enforcement without requiring explicit exception handling.
 *
 * @see ResourceQuota
 * @see ResourceMonitor
 */
