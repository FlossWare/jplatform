...
/**
 * Platform-aware application interface. Applications implementing this interface gain access to
 * platform features like thread pools, messaging, and resource monitoring.
 *
 * <p>Applications can also use a standard {@code main(String[] args)} method instead, but will not
 * have access to platform features.
 *
...
public interface Application {
  ...
  /**
   * Called when the application is stopped by the platform. Implementations should clean up
   * resources and shut down gracefully.
   *
