...
/**
 * Immutable collection of resource usage snapshots over time. Useful for tracking resource usage
 * trends and analyzing application behavior.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class ResourceUsageHistory {
  ...
  /**
   * Constructs a new resource usage history with the given snapshots. The snapshot list is copied
