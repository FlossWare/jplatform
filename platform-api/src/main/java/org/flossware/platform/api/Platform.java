 ...
 *
 * <p>Used to select platform-specific native libraries or binaries. The platform automatically
 * detects the current OS and architecture using system properties.
 *
 * @since 2.0
 */
