...
/**
 * Represents a node in the platform cluster. Contains information about node identity, location,
 * and health status.
 *
 * @see ClusterManager
 */
public class ClusterNode {
   ...
   * @throws IllegalArgumentException if nodeId or address is null/empty, port is invalid, or
   *     lastHeartbeat is negative
  ...
  public String toString() {
    return String.format(
        "ClusterNode{nodeId='%s', address='%s', port=%d, state=%s}", nodeId, address, port, state);
  }
