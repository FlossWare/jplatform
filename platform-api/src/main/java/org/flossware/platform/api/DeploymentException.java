...
/**
 * Thrown when application deployment or undeployment fails. This exception indicates failures
 * during:
 *
 * <ul>
 *   <li>Application deployment (classloader creation, resource allocation)
 *   <li>Application undeployment (resource cleanup, classloader disposal)
 *   <li>Hot reload operations
 * </ul>
 *
 * @since 1.2
 */
