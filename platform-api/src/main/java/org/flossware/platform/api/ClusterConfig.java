...
/**
 * Configuration for cluster membership and coordination. Specifies cluster name, network settings,
 * and seed nodes for discovery.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class ClusterConfig {
  ...
  private ClusterConfig(Builder builder) {
    ...
    this.seedNodes =
        builder.seedNodes != null ? List.copyOf(builder.seedNodes) : Collections.emptyList();
