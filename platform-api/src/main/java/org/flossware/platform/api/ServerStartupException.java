...
/**
 * Thrown when a platform server (HTTP API, web console) fails to start. This exception indicates
 * failures during server initialization, port binding, or other startup-related issues.
 *
 * @since 1.2
 */
