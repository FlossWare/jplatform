...
/**
 * Defines resource limits for an application. Quotas can be set for heap memory, thread count, and
 * CPU time. All limits are optional - only configured limits are enforced.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class ResourceQuota {
  ...
  /**
   * Checks if the given resource snapshot violates any configured quotas. Throws an exception if
  ...
  /** Builder for constructing ResourceQuota instances. All quota limits are optional. */
