 ...
 *
 * <p>Applications can declare dependencies on services to ensure proper startup ordering and
 * availability validation. The platform validates dependencies at deploy time and starts
 * applications in the correct order based on the dependency graph.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class ApplicationDependency {
  ...
  public enum DependencyType {
    ...
    /**
     * Optional dependency - application starts even if service is unavailable. The application
     * should handle the missing service gracefully.
     */
    OPTIONAL
  }
