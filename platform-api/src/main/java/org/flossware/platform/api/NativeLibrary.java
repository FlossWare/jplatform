 ...
 *
 * <p>Native libraries (.so, .dll, .dylib) can be bundled with applications and loaded automatically
 * by the platform. Each library can target specific operating systems and architectures.
 *
 * <p>Example usage:
 *
 * <pre>{@code
