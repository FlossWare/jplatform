...
/**
 * Thrown when a node fails to join a cluster. This exception indicates failures during cluster
 * initialization, seed node connection, or network configuration issues.
 *
 * @since 1.2
 */
