...
/**
 * Thrown when an application fails to start. This exception indicates that the application's
 * start() method failed, or that the platform could not transition the application to RUNNING
 * state.
 *
 * @since 1.2
 */
