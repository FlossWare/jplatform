...
/**
 * Thrown when a node fails to leave a cluster gracefully. This exception indicates failures during
 * cluster shutdown, member deregistration, or cleanup operations.
 *
 * @since 1.2
 */
