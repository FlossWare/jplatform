...
/**
 * Thrown when a platform server (HTTP API, web console) fails to stop gracefully. This exception
 * indicates failures during server shutdown or resource cleanup.
 *
 * @since 1.2
 */
