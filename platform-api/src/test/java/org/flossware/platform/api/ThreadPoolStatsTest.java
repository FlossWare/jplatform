...
class ThreadPoolStatsTest {
  ...
  void testConstructor_negativeActiveThreads() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(-1, 100, 10, 10, 2, 20));
  ...
  void testConstructor_negativeCompletedTasks() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, -1, 10, 10, 2, 20));
  ...
  void testConstructor_negativeQueuedTasks() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, 100, -1, 10, 2, 20));
  ...
  void testConstructor_negativePoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, 100, 10, -1, 2, 20));
  ...
  void testConstructor_negativeCorePoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, 100, 10, 10, -1, 20));
  ...
  void testConstructor_negativeMaximumPoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, 100, 10, 10, 2, -1));
  ...
  void testConstructor_maximumLessThanCore() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, 100, 10, 10, 20, 10));
  ...
  void testConstructor_poolSizeExceedsMaximum() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, 100, 10, 50, 2, 20));
  ...
  void testConstructor_activeThreadsExceedsPoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(15, 100, 10, 10, 2, 20));
  ...
  void testConstructor_largeValues() {
    ThreadPoolStats stats = new ThreadPoolStats(100, Long.MAX_VALUE, 1000, 200, 50, 200);
  ...
  void testConstructor_invalidBoundary_poolSizeExceedsMaxByOne() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(5, 100, 10, 21, 2, 20));
  ...
  void testConstructor_invalidBoundary_activeThreadsExceedsPoolByOne() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> new ThreadPoolStats(11, 100, 10, 10, 2, 20));
