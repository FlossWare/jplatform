...
/**
 * Comprehensive unit tests for ClusterConfig and its Builder. Tests builder validation, defaults,
...
class ClusterConfigTest {
  ...
  void testBuilderClusterNameNull() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().clusterName(null));
  }

  @Test
  void testBuilderClusterNameEmpty() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().clusterName(""));
  }
  ...
  void testBuilderBindAddressNull() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().bindAddress(null));
  }

  @Test
  void testBuilderBindAddressEmpty() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().bindAddress(""));
  }
  ...
  void testBuilderBindPortZero() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().bindPort(0));
  }

  @Test
  void testBuilderBindPortNegative() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().bindPort(-1));
  }

  @Test
  void testBuilderBindPortTooHigh() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().bindPort(65536));
  }

  @Test
  void testBuilderBindPortMinValid() {
    ClusterConfig config = ClusterConfig.builder().bindPort(1).build();
  ...
  void testBuilderBindPortMaxValid() {
    ClusterConfig config = ClusterConfig.builder().bindPort(65535).build();
  ...
  void testBuilderAddSeedNodeNull() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().addSeedNode(null));
  }

  @Test
  void testBuilderAddSeedNodeEmpty() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().addSeedNode(""));
  }
  ...
  void testBuilderSeedNodesNull() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().seedNodes(null));
  }
  ...
  void testBuilderSeedNodesEmpty() {
    ClusterConfig config =
        ClusterConfig.builder().addSeedNode("node1:5701").seedNodes(List.of()).build();
  ...
  void testBuilderStateBackendNull() {
    assertThrows(IllegalArgumentException.class, () -> ClusterConfig.builder().stateBackend(null));
  }

  @Test
  void testBuilderStateBackendHazelcast() {
    ClusterConfig config =
        ClusterConfig.builder().stateBackend(ClusterConfig.StateBackend.HAZELCAST).build();
  ...
  void testBuilderStateBackendRedis() {
    ClusterConfig config =
        ClusterConfig.builder().stateBackend(ClusterConfig.StateBackend.REDIS).build();
  ...
  void testBuilderStateBackendMemory() {
    ClusterConfig config =
        ClusterConfig.builder().stateBackend(ClusterConfig.StateBackend.MEMORY).build();
  ...
  void testGetSeedNodesIsUnmodifiable() {
    ClusterConfig config = ClusterConfig.builder().addSeedNode("node1:5701").build();

    List<String> seedNodes = config.getSeedNodes();

    assertThrows(UnsupportedOperationException.class, () -> seedNodes.add("node2:5701"));
  }
  ...
  void testStateBackendValueOf() {
    assertEquals(
        ClusterConfig.StateBackend.HAZELCAST, ClusterConfig.StateBackend.valueOf("HAZELCAST"));
    assertEquals(ClusterConfig.StateBackend.REDIS, ClusterConfig.StateBackend.valueOf("REDIS"));
    assertEquals(ClusterConfig.StateBackend.MEMORY, ClusterConfig.StateBackend.valueOf("MEMORY"));
  }
  ...
  void testBuilderReuse() {
    ClusterConfig.Builder builder = ClusterConfig.builder().clusterName("test-cluster");

    ClusterConfig config1 = builder.build();
    ClusterConfig config2 = builder.bindPort(8080).build();
