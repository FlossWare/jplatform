...
class ThreadPoolConfigTest {
  ...
  void testBuilderWithEqualCoreAndMaxPoolSize() {
    ThreadPoolConfig config = ThreadPoolConfig.builder().corePoolSize(10).maxPoolSize(10).build();
  ...
  void testBuilderRejectsNegativeCorePoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            ...
            () -> ThreadPoolConfig.builder().corePoolSize(-1).build());
  ...
  void testBuilderRejectsZeroMaxPoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> ThreadPoolConfig.builder().maxPoolSize(0).build());
  ...
  void testBuilderRejectsNegativeMaxPoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> ThreadPoolConfig.builder().maxPoolSize(-5).build());
  ...
  void testBuilderRejectsMaxPoolSizeLessThanCorePoolSize() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> ThreadPoolConfig.builder().corePoolSize(10).maxPoolSize(5).build());
  ...
  void testBuilderRejectsNegativeKeepAliveTime() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> ThreadPoolConfig.builder().keepAliveTimeSeconds(-1).build());
  ...
  void testBuilderRejectsNegativeQueueCapacity() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> ThreadPoolConfig.builder().queueCapacity(-100).build());
    assertEquals("queueCapacity must be >= 0, got: -100", exception.getMessage());
  }

  @Test
  void testBuilderWithZeroCorePoolSizeIsValid() {
    ThreadPoolConfig config = ThreadPoolConfig.builder().corePoolSize(0).maxPoolSize(5).build();
  ...
  void testBuilderWithZeroKeepAliveTimeIsValid() {
    ThreadPoolConfig config = ThreadPoolConfig.builder().keepAliveTimeSeconds(0).build();
  ...
  void testBuilderWithZeroQueueCapacityIsValid() {
    ThreadPoolConfig config = ThreadPoolConfig.builder().queueCapacity(0).build();
