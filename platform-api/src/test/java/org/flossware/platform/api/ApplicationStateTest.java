...
/**
 * Comprehensive unit tests for ApplicationState enum. Tests all enum values and basic enum
 * functionality.
 */
class ApplicationStateTest {
  ...
  void testValueOfInvalid() {
    assertThrows(IllegalArgumentException.class, () -> ApplicationState.valueOf("INVALID"));
  }

  @Test
  void testValueOfNull() {
    assertThrows(NullPointerException.class, () -> ApplicationState.valueOf(null));
  }
