...
/**
 * Comprehensive unit tests for VolumeMount. Tests constructor validation, getters, and utility
 * methods.
 */
class VolumeMountTest {
  ...
  void testConstructorNullName() {
    assertThrows(
        IllegalArgumentException.class, () -> new VolumeMount(null, "/var/db", true, 1024));
  }

  @Test
  void testConstructorEmptyName() {
    assertThrows(IllegalArgumentException.class, () -> new VolumeMount("", "/var/db", true, 1024));
  }

  @Test
  void testConstructorWhitespaceName() {
    assertThrows(
        IllegalArgumentException.class, () -> new VolumeMount("   ", "/var/db", true, 1024));
  }

  @Test
  void testConstructorNullMountPath() {
    assertThrows(
        IllegalArgumentException.class, () -> new VolumeMount("database", null, true, 1024));
  }

  @Test
  void testConstructorEmptyMountPath() {
    assertThrows(IllegalArgumentException.class, () -> new VolumeMount("database", "", true, 1024));
  }

  @Test
  void testConstructorWhitespaceMountPath() {
    assertThrows(
        IllegalArgumentException.class, () -> new VolumeMount("database", "   ", true, 1024));
  }

  @Test
  void testConstructorNegativeMaxSize() {
    assertThrows(
        IllegalArgumentException.class, () -> new VolumeMount("database", "/var/db", true, -1));
  }
