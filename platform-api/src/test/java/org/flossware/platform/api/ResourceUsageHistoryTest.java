...
class ResourceUsageHistoryTest {
  ...
  void testConstructor_nullElementAtStart() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> new ResourceUsageHistory(snapshots));
  ...
  void testGetSnapshots_immutable() {
    ...
    assertThrows(UnsupportedOperationException.class, () -> retrieved.add(createSnapshot(3000)));
  }
