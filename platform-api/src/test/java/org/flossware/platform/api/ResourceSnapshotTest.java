...
class ResourceSnapshotTest {
  ...
  void testConstructor_validParameters() {
    ...
    ResourceSnapshot snapshot = new ResourceSnapshot(timestamp, 1000, 100, 5, 10, 20, null);
  ...
  void testConstructor_heapUsedMinusOneAllowed() {
    ...
    ResourceSnapshot snapshot =
        new ResourceSnapshot(System.currentTimeMillis(), 1000, -1, 5, 10, 20, null);
  ...
  void testConstructor_zeroValues() {
    ResourceSnapshot snapshot = new ResourceSnapshot(0, 0, 0, 0, 0, 0, null);
  ...
  void testGetCustomMetrics_emptyWhenNull() {
    ResourceSnapshot snapshot =
        new ResourceSnapshot(System.currentTimeMillis(), 1000, 100, 5, 10, 20, null);
  ...
  void testGetCustomMetrics_immutable() {
    ...
    assertThrows(UnsupportedOperationException.class, () -> retrieved.put("metric2", 200));
  }
}
