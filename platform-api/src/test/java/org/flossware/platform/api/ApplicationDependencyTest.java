...
/**
 * Comprehensive unit tests for ApplicationDependency. Tests constructor validation, getters,
 * isRequired(), isOptional(), equals(), hashCode(), and toString().
 */
class ApplicationDependencyTest {

  @Test
  void testConstructorValid() {
    ApplicationDependency dep =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.REQUIRED, "1.0.0");
  ...
  void testConstructorNullVersion() {
    ...
    ApplicationDependency dep =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.OPTIONAL, null);
  ...
  void testConstructorNullServiceInterface() {
    assertThrows(
        ...
        () ->
            new ApplicationDependency(
                null, ApplicationDependency.DependencyType.REQUIRED, "1.0.0"));
  }
  ...
  void testIsOptionalWhenOptional() {
    ApplicationDependency dep =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.OPTIONAL, "1.0.0");
  ...
  void testEqualsIdentical() {
    ApplicationDependency dep1 =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.REQUIRED, "1.0.0");
    ApplicationDependency dep2 =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.REQUIRED, "1.0.0");
  ...
  void testEqualsDifferentServiceInterface() {
    ApplicationDependency dep1 =
        new ApplicationDependency(
            "com.example.Service1", ApplicationDependency.DependencyType.REQUIRED, "1.0.0");
    ApplicationDependency dep2 =
        new ApplicationDependency(
            "com.example.Service2", ApplicationDependency.DependencyType.REQUIRED, "1.0.0");
  ...
  void testEqualsDifferentVersion() {
    ...
    ApplicationDependency dep2 =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.REQUIRED, "2.0.0");
  ...
  void testLatestVersionDefault() {
    ApplicationDependency dep =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.REQUIRED, null);
  ...
  void testExplicitLatestVersion() {
    ApplicationDependency dep =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.OPTIONAL, "latest");
  ...
  void testSemanticVersion() {
    ApplicationDependency dep =
        new ApplicationDependency(
            "com.example.Service", ApplicationDependency.DependencyType.REQUIRED, "2.3.4");
