...
/**
 * Configuration for ZooKeeper-based configuration source. Provides connection settings for
 * ZooKeeper ensemble and configuration parameters.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class ZooKeeperConfigSourceConfig {
  ...
  /**
   * Returns the base path for configuration keys. All configuration keys will be stored under this
   * path.
   *
  ...
  /** Builder for ZooKeeperConfigSourceConfig instances. Provides a fluent API for configuration. */
