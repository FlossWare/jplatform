...
package org.flossware.platform.config.zookeeper;
...
class ZooKeeperConfigSourceConfigTest {
  ...
  void testBuilderDefaults() {
    ZooKeeperConfigSourceConfig config = ZooKeeperConfigSourceConfig.builder().build();
  ...
  void testBuilderWithAllFields() {
    ZooKeeperConfigSourceConfig config =
  ...
  void testMissingConnectString() {
    Exception exception =
        assertThrows(
            ...
            () -> {
              ZooKeeperConfigSourceConfig.builder().connectString(null).build();
            });
  ...
  void testEmptyConnectString() {
    Exception exception =
        assertThrows(
            IllegalStateException.class,
            () -> {
              ZooKeeperConfigSourceConfig.builder().connectString("  ").build();
            });
    assertTrue(exception.getMessage().contains("Connect string"));
  }
  ...
  void testMissingBasePath() {
    Exception exception =
        assertThrows(
            IllegalStateException.class,
            () -> {
              ZooKeeperConfigSourceConfig.builder().basePath(null).build();
            });
  ...
  void testEmptyBasePath() {
    Exception exception =
        assertThrows(
            IllegalStateException.class,
            () -> {
              ZooKeeperConfigSourceConfig.builder().basePath("").build();
            });
    assertTrue(exception.getMessage().contains("Base path"));
  }
  ...
  void testSessionTimeoutTooSmall() {
    Exception exception =
        assertThrows(
            ...
            () -> {
              ZooKeeperConfigSourceConfig.builder().sessionTimeoutMs(500).build();
            });
  ...
  void testConnectionTimeoutTooSmall() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> {
              ZooKeeperConfigSourceConfig.builder().connectionTimeoutMs(999).build();
            });
  ...
  void testRetryCountNegative() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> {
              ZooKeeperConfigSourceConfig.builder().retryCount(-1).build();
            });
  ...
  void testRetryIntervalTooSmall() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> {
              ZooKeeperConfigSourceConfig.builder().retryIntervalMs(50).build();
            });
  ...
  void testEnsembleConfiguration() {
    ZooKeeperConfigSourceConfig config =
        ZooKeeperConfigSourceConfig.builder().connectString("zk1:2181,zk2:2181,zk3:2181").build();
  ...
  void testCustomBasePath() {
    ZooKeeperConfigSourceConfig config =
        ZooKeeperConfigSourceConfig.builder().basePath("/myapp/config/production").build();
  ...
  void testRetryCountZero() {
    ZooKeeperConfigSourceConfig config =
        ZooKeeperConfigSourceConfig.builder().retryCount(0).build();
