...
class ApplicationMBeanImplTest {
  ...
  void testConstructorNullApplicationId() {
    assertThrows(
        IllegalArgumentException.class, () -> new ApplicationMBeanImpl(null, context, manager));
  }

  @Test
  void testConstructorEmptyApplicationId() {
    assertThrows(
        IllegalArgumentException.class, () -> new ApplicationMBeanImpl("", context, manager));
  }

  @Test
  void testConstructorNullContext() {
    assertThrows(
        IllegalArgumentException.class, () -> new ApplicationMBeanImpl("test-app", null, manager));
  }

  @Test
  void testConstructorNullManager() {
    assertThrows(
        IllegalArgumentException.class, () -> new ApplicationMBeanImpl("test-app", context, null));
  }
