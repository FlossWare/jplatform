...
class JmxMetricsExporterTest {
    ...
    void testRegisterApplication() throws Exception {
        ...
        ObjectName objectName = new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId);
    ...
    void testUnregisterApplication() throws Exception {
        ...
        ObjectName objectName = new ObjectName("org.flossware.platform.test:type=Application,id=test-app");
    ...
    void testMultipleApplications() throws Exception {
        ...
        ObjectName objectName1 = new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId1);
        ObjectName objectName2 = new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId2);
        ObjectName objectName3 = new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId3);
