...
class JmxMetricsExporterTest {
  ...
  void setUp() {
    config =
        JmxExporterConfig.builder()
            ...
            .domain("org.flossware.platform.test")
            .build();
  ...
  void tearDown() throws Exception {
    ...
    try {
      ObjectName pattern = new ObjectName("org.flossware.platform.test:type=Application,*");
  ...
  void testConstructorNullConfig() {
    assertThrows(IllegalArgumentException.class, () -> new JmxMetricsExporter(null, manager));
  }

  @Test
  void testConstructorNullManager() {
    assertThrows(IllegalArgumentException.class, () -> new JmxMetricsExporter(config, null));
  }
  ...
  void testStartSuccess() throws Exception {
    ...
    assertEquals("org.flossware.platform.test", exporter.getDomain());
  ...
  void testRegisterApplication() throws Exception {
    ...
    ObjectName objectName =
        new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId);
  ...
  void testRegisterApplicationNullId() throws Exception {
    ...
    assertThrows(IllegalArgumentException.class, () -> exporter.registerApplication(null, context));
  }
  ...
  void testRegisterApplicationEmptyId() throws Exception {
    ...
    assertThrows(IllegalArgumentException.class, () -> exporter.registerApplication("", context));
  }
  ...
  void testRegisterApplicationNullContext() throws Exception {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> exporter.registerApplication("test-app", null));
  }
  ...
  void testUnregisterApplication() throws Exception {
    ...
    ObjectName objectName =
        new ObjectName("org.flossware.platform.test:type=Application,id=test-app");
  ...
  void testUnregisterApplicationNullId() throws Exception {
    ...
    assertThrows(IllegalArgumentException.class, () -> exporter.unregisterApplication(null));
  }
  ...
  void testUnregisterApplicationEmptyId() throws Exception {
    ...
    assertThrows(IllegalArgumentException.class, () -> exporter.unregisterApplication(""));
  }
  ...
  void testStopUnregistersAllApplications() throws Exception {
    ...
    ObjectName objectName1 = new ObjectName("org.flossware.platform.test:type=Application,id=app1");
    ObjectName objectName2 = new ObjectName("org.flossware.platform.test:type=Application,id=app2");
    ObjectName objectName3 = new ObjectName("org.flossware.platform.test:type=Application,id=app3");
  ...
  void testMultipleApplications() throws Exception {
    ...
    ObjectName objectName1 =
        new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId1);
    ObjectName objectName2 =
        new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId2);
    ObjectName objectName3 =
        new ObjectName("org.flossware.platform.test:type=Application,id=" + quotedAppId3);
  ...
  void testGetPort() {
    ...
    JmxExporterConfig configWithPort =
        JmxExporterConfig.builder().enabled(true).port(9999).domain("test").build();
