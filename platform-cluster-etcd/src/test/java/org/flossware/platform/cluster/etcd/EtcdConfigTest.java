...
/**
 * Comprehensive unit tests for EtcdConfig. Tests builder validation, default values, and all
...
class EtcdConfigTest {
  ...
  void testAddSingleEndpoint() {
    EtcdConfig config = EtcdConfig.builder().addEndpoint("http://etcd1:2379").build();
  ...
  void testAddLocalhostExplicitlyAddsAnother() {
    EtcdConfig config = EtcdConfig.builder().addEndpoint("http://localhost:2379").build();
  ...
  void testAddEndpointNullThrowsException() {
    assertThrows(IllegalArgumentException.class, () -> EtcdConfig.builder().addEndpoint(null));
  }

  @Test
  void testAddEndpointEmptyThrowsException() {
    assertThrows(IllegalArgumentException.class, () -> EtcdConfig.builder().addEndpoint(""));
  }
  ...
  void testSetEndpointsList() {
    List<String> endpoints =
        Arrays.asList("http://etcd1:2379", "http://etcd2:2379", "http://etcd3:2379");

    EtcdConfig config = EtcdConfig.builder().endpoints(endpoints).build();
  ...
  void testSetEndpointsReplacesExisting() {
    List<String> endpoints = Arrays.asList("http://etcd1:2379", "http://etcd2:2379");

    EtcdConfig config =
        EtcdConfig.builder().addEndpoint("http://temp:2379").endpoints(endpoints).build();
  ...
  void testSetEndpointsNullThrowsException() {
    assertThrows(IllegalArgumentException.class, () -> EtcdConfig.builder().endpoints(null));
  }
  ...
  void testSetEndpointsWithNullEntryThrowsException() {
    ...
    assertThrows(IllegalArgumentException.class, () -> EtcdConfig.builder().endpoints(endpoints));
  }
  ...
  void testEndpointsImmutable() {
    ...
    assertThrows(
        UnsupportedOperationException.class, () -> config.getEndpoints().add("http://etcd2:2379"));
  }

  @Test
  void testSetLeaseTtl() {
    EtcdConfig config = EtcdConfig.builder().leaseTtl(30).build();
  ...
  void testSetLeaseTtlMinimum() {
    EtcdConfig config = EtcdConfig.builder().leaseTtl(5).build();
  ...
  void testSetLeaseTtlMaximum() {
    EtcdConfig config = EtcdConfig.builder().leaseTtl(86400).build();
  ...
  void testSetLeaseTtlTooSmallThrowsException() {
    assertThrows(IllegalArgumentException.class, () -> EtcdConfig.builder().leaseTtl(4));
  }

  @Test
  void testSetLeaseTtlTooLargeThrowsException() {
    assertThrows(IllegalArgumentException.class, () -> EtcdConfig.builder().leaseTtl(86401));
  }

  @Test
  void testSetNamespace() {
    EtcdConfig config = EtcdConfig.builder().namespace("/mynamespace").build();
  ...
  void testSetNamespaceNull() {
    EtcdConfig config = EtcdConfig.builder().namespace(null).build();
  ...
  void testSetUsername() {
    EtcdConfig config = EtcdConfig.builder().username("admin").build();
  ...
  void testSetUsernameNull() {
    EtcdConfig config = EtcdConfig.builder().username(null).build();
  ...
  void testSetPassword() {
    EtcdConfig config = EtcdConfig.builder().password("secret").build();
  ...
  void testSetPasswordNull() {
    EtcdConfig config = EtcdConfig.builder().password(null).build();
  ...
  void testBuilderReuse() {
    EtcdConfig.Builder builder = EtcdConfig.builder().addEndpoint("http://etcd1:2379").leaseTtl(15);
