...
/**
 * Comprehensive unit tests for PlatformClassLoadListener. Tests lifecycle event handling and
 * logging integration. Note: This listener primarily logs events, so tests verify it doesn't throw
 * exceptions.
 */
class PlatformClassLoadListenerTest {
  ...
  void testOnClassLoadFailedWithNullError() {
    ...
    assertThrows(NullPointerException.class, () -> listener.onClassLoadFailed(className, null));
  }
