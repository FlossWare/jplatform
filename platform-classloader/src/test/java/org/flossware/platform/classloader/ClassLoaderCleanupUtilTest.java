...
class ClassLoaderCleanupUtilTest {
  ...
  void setUp() throws Exception {
    ...
    testClassLoader =
        new URLClassLoader(new URL[] {}, ClassLoaderCleanupUtilTest.class.getClassLoader());
  ...
  void testCleanupWithNullApplicationId() {
    ...
    ClassLoaderCleanupUtil nullIdCleanup = new ClassLoaderCleanupUtil(null, testClassLoader);
