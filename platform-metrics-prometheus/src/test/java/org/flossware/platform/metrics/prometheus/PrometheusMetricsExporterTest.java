...
class PrometheusMetricsExporterTest {
  ...
  void setUp() throws IOException {
    ...
    config = PrometheusExporterConfig.builder().port(port).path("/metrics").build();
  ...
  void testDifferentPath() throws IOException {
    int port = findAvailablePort();
    PrometheusExporterConfig customConfig =
        PrometheusExporterConfig.builder().port(port).path("/custom-metrics").build();
