...
/**
 * Configuration for JDBC-based storage. Stores volume metadata in a relational database.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class DatabaseStorageConfig {
  ...
  /** Builder for DatabaseStorageConfig instances. Provides a fluent API for configuration. */
