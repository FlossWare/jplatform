...
/**
 * Comprehensive unit tests for ApplicationSecurityPolicy. Tests permission checking, enforcement,
 * and configuration.
 */
class ApplicationSecurityPolicyTest {
  ...
  void testConstructorNullApplicationId() {
    ...
    assertThrows(NullPointerException.class, () -> new ApplicationSecurityPolicy(null, config));
  }

  @Test
  void testConstructorNullConfig() {
    assertThrows(NullPointerException.class, () -> new ApplicationSecurityPolicy(APP_ID, null));
  }

  @Test
  void testConstructorValid() {
    SecurityConfig config =
        SecurityConfig.builder().allowReflection(true).allowNativeCode(false).build();
  ...
  void testCheckPermissionNullPermission() {
    ...
    assertThrows(NullPointerException.class, () -> policy.checkPermission(null));
  }
  ...
  void testCheckPermissionFilePermissionDenied() {
    SecurityConfig config =
        SecurityConfig.builder().addFilePermission(new FilePermission("/tmp/*", "read")).build();
  ...
  void testCheckPermissionReflectionAllowed() {
    SecurityConfig config = SecurityConfig.builder().allowReflection(true).build();
  ...
  void testCheckPermissionReflectionDenied() {
    SecurityConfig config = SecurityConfig.builder().allowReflection(false).build();
  ...
  void testCheckPermissionNativeCodeAllowed() {
    SecurityConfig config = SecurityConfig.builder().allowNativeCode(true).build();
  ...
  void testCheckPermissionNativeCodeDenied() {
    SecurityConfig config = SecurityConfig.builder().allowNativeCode(false).build();
  ...
  void testEnforcePermissionGranted() {
    ...
    assertDoesNotThrow(() -> policy.enforce(new FilePermission("/tmp/test.txt", "read")));
  }
  ...
  void testEnforceNullPermission() {
    ...
    assertThrows(NullPointerException.class, () -> policy.enforce(null));
  }
  ...
  void testReflectionAndNativeCodeBothAllowed() {
    SecurityConfig config =
        SecurityConfig.builder().allowReflection(true).allowNativeCode(true).build();
  ...
  void testReflectionAndNativeCodeBothDenied() {
    SecurityConfig config =
        SecurityConfig.builder().allowReflection(false).allowNativeCode(false).build();
