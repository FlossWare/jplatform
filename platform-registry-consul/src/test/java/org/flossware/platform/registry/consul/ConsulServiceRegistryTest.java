...
class ConsulServiceRegistryTest {
  ...
  void testRegisterService_NullInterface() {
    assertThrows(
        NullPointerException.class, () -> registry.registerService(null, new TestServiceImpl()));
  }

  @Test
  void testRegisterService_NullImplementation() {
    assertThrows(
        NullPointerException.class, () -> registry.registerService(TestService.class, null));
  }

  @Test
  void testRegisterService_NotAnInterface() {
    assertThrows(
        IllegalArgumentException.class, () -> registry.registerService(String.class, "test"));
  }
