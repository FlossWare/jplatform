...
/**
 * Configuration for Consul-based service registry. Provides connection settings for Consul agent
 * and service registration parameters.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class ConsulRegistryConfig {
  ...
  /**
   * Returns the service TTL in seconds. Services must send health check passes within this
   * interval.
   *
  ...
  /**
   * Returns the unique node identifier. Used to distinguish services from different nodes.
   *
   * @return the node ID
   */
  ...
  /**
   * Returns the service name prefix. Service names will be prefixed with this value.
   *
  ...
  /** Builder for ConsulRegistryConfig instances. Provides a fluent API for configuration. */
