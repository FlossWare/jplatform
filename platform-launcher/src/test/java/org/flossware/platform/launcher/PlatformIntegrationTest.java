...
/**
 * Integration tests for platform-java launcher. Tests end-to-end functionality of all deployment
 * methods and monitoring features.
 */
  ...
  void testYamlDeploymentEndToEnd() throws Exception {
    ...
    String yaml =
        "applicationId: test-app\n"
            ...
            + "version: 1.0.0\n"
            + "mainClass: org.flossware.platform.samples.helloworld.HelloWorldApp\n"
            + "classpathEntries:\n"
            + "  - file:///tmp/test.jar\n"
            + "threadPool:\n"
            + "  corePoolSize: 2\n"
