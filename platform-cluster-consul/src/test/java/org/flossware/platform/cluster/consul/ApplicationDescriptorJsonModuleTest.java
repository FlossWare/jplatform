...
/**
 * Tests for ApplicationDescriptorJsonModule. Tests custom Jackson serialization/deserialization of
...
class ApplicationDescriptorJsonModuleTest {
  ...
  void testDeserializeMinimalDescriptor() throws Exception {
    String json =
        "{\"applicationId\":\"app1\",\"name\":\"Test App\",\"version\":\"1.0\",\"mainClass\":\"com.example.Main\"}";
  ...
  void testDeserializeWithClasspath() throws Exception {
    String json =
        "{\"applicationId\":\"app1\",\"name\":\"Test App\",\"version\":\"1.0\","
            + "\"mainClass\":\"com.example.Main\","
  ...
  void testSerializeDeserializeRoundTrip() throws Exception {
    ApplicationDescriptor original =
        ApplicationDescriptor.builder()
            .applicationId("app1")
            .name("Test App")
            .version("1.0")
    ...
    assertEquals(
        original.getThreadPoolConfig().getCorePoolSize(),
