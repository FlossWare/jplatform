 ...
 *
 * <p>Provides methods to measure heap usage for specific ClassLoaders, enabling precise memory
 * tracking for isolated applications.
 *
 * <h3>Implementations</h3>
 *
 * <ul>
 *   <li><strong>JvmtiHeapProfiler</strong> - Uses native JVMTI agent for exact measurements
 *   <li><strong>EstimatingHeapProfiler</strong> - Uses heuristics and JVM-wide metrics
 * </ul>
 *
 * <h3>Usage</h3>
 *
 ...
 * @version 1.0
 * @since 1.0
 * @see org.flossware.platform.jvmti.JvmtiHeapProfiler
 */
public interface HeapProfiler {
   ...
   *
   * <p>This method should be called before measuring heap usage to activate profiling for the
   * application. Some implementations may use this to set up tracking structures or enable JVM
   * features.
   *
   ...
   *
   * <p>After calling this method, heap measurements may no longer be accurate for the application.
   * Implementations should clean up any tracking structures or resources associated with the
   * application.
   *
   * @param applicationId the unique identifier for the application
   * @throws IllegalArgumentException if applicationId is null or empty
   ...
   *
   * <p>This includes all objects whose classes were loaded by the ClassLoader, including objects in
   * all generations (young, old, metaspace).
   *
   * <h3>Implementation Notes</h3>
   *
   * <ul>
   *   <li>JVMTI-based: Iterates heap and sums sizes of matching objects
   *   <li>Estimation-based: Uses heuristics based on JVM-wide metrics
   * </ul>
   *
   ...
   *
   * <p>The returned map contains class names as keys (e.g., "java.lang.String",
   * "com.example.MyClass") and their corresponding heap usage in bytes as values.
   *
   * <h3>Implementation Notes</h3>
   *
   * <ul>
   *   <li>JVMTI-based: Iterates heap and groups by class name
   *   <li>Estimation-based: May return empty map or approximate values
   * </ul>
   *
   * <h3>Performance</h3>
   *
