...
class EnforcementPolicyTest {
  ...
  void testConstructor_nullApplicationId() {
    NullPointerException exception =
        assertThrows(NullPointerException.class, () -> new EnforcementPolicy(null, 3));
  ...
  void testConstructor_zeroGracePeriod() {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> new EnforcementPolicy("app1", 0));
  ...
  void testConstructor_negativeGracePeriod() {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> new EnforcementPolicy("app1", -1));
  ...
  void testRecordViolation_nullResourceType() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> policy.recordViolation(null));
  ...
  void testRecordViolation_emptyResourceType() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> policy.recordViolation(""));
  ...
  void testClearViolation_nullResourceType() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> policy.clearViolation(null));
  ...
  void testClearViolation_emptyResourceType() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> policy.clearViolation(""));
  ...
  void testGetViolationCount_nullResourceType() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> policy.getViolationCount(null));
  ...
  void testGetViolationCount_emptyResourceType() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> policy.getViolationCount(""));
