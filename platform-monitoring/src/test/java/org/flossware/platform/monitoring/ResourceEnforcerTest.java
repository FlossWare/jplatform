...
/**
 * Comprehensive unit tests for ResourceEnforcer. Tests quota enforcement actions, grace periods,
 * and different violation types.
 */
class ResourceEnforcerTest {
  ...
  void testConstructorWithoutThrottle() {
    ResourceEnforcer enforcer =
        new ResourceEnforcer(
            TEST_APP_ID, defaultConfig, testThreadGroup, mockShutdownAction, mockKillAction);
  ...
  void testConstructorNullApplicationId() {
    assertThrows(
        ...
        () -> {
          new ResourceEnforcer(
              null, defaultConfig, testThreadGroup, mockShutdownAction, mockKillAction);
        });
  }
  ...
  void testConstructorNullConfig() {
    assertThrows(
        ...
        () -> {
          new ResourceEnforcer(
              TEST_APP_ID, null, testThreadGroup, mockShutdownAction, mockKillAction);
        });
  }
  ...
  void testConstructorNullThreadGroup() {
    assertThrows(
        ...
        () -> {
          new ResourceEnforcer(
              TEST_APP_ID, defaultConfig, null, mockShutdownAction, mockKillAction);
        });
  }
  ...
  void testConstructorNullShutdownAction() {
    assertThrows(
        NullPointerException.class,
        () -> {
          new ResourceEnforcer(TEST_APP_ID, defaultConfig, testThreadGroup, null, mockKillAction);
        });
  }
  ...
  void testConstructorNullKillAction() {
    assertThrows(
        ...
        () -> {
          new ResourceEnforcer(
              TEST_APP_ID, defaultConfig, testThreadGroup, mockShutdownAction, null);
        });
  }
  ...
  void testShutdownActionTriggered() {
    ...
    ResourceEnforcer enforcer =
        new ResourceEnforcer(
            TEST_APP_ID, config, testThreadGroup, mockShutdownAction, mockKillAction);
  ...
  void testThreadQuotaEnforcement() {
    ...
    ResourceQuota quota = ResourceQuota.builder().maxThreadCount(10).build();
  ...
  void testActionExceptionDoesNotPropagate() {
    ...
    ResourceEnforcer enforcer =
        new ResourceEnforcer(TEST_APP_ID, config, testThreadGroup, failingAction, mockKillAction);
