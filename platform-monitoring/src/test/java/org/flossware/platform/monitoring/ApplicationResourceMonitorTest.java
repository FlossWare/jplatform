...
/**
 * Comprehensive unit tests for ApplicationResourceMonitor. Tests resource tracking, quota
 * enforcement, listener notifications, and shutdown.
 */
class ApplicationResourceMonitorTest {
  ...
  void testSetAndGetEnforcer() {
    ...
    ResourceEnforcer enforcer =
        new ResourceEnforcer(TEST_APP_ID, config, testThreadGroup, appId -> {}, appId -> {});
  ...
  void testAddAndRemoveListener() {
    ...
    ResourceEventListener listener =
        new ResourceEventListener() {
          @Override
          public void onQuotaExceeded(
              String applicationId, ResourceQuota quota, ResourceSnapshot snapshot) {}
  ...
  void testQuotaExceededFiresListener() throws InterruptedException {
    ...
    ResourceQuota quota = ResourceQuota.builder().maxThreadCount(1).build();
  ...
  void testMultipleListeners() throws InterruptedException {
    ...
    ResourceEventListener listener1 =
        new ResourceEventListener() {
          @Override
          public void onQuotaExceeded(
              String applicationId, ResourceQuota quota, ResourceSnapshot snapshot) {
    ...
    ResourceEventListener listener2 =
        new ResourceEventListener() {
          @Override
          public void onQuotaExceeded(
              String applicationId, ResourceQuota quota, ResourceSnapshot snapshot) {
  ...
  void testListenerExceptionDoesNotStopOtherListeners() throws InterruptedException {
    ...
    ResourceEventListener badListener =
        new ResourceEventListener() {
          @Override
          public void onQuotaExceeded(
              String applicationId, ResourceQuota quota, ResourceSnapshot snapshot) {
    ...
    ResourceEventListener goodListener =
        new ResourceEventListener() {
          @Override
          public void onQuotaExceeded(
              String applicationId, ResourceQuota quota, ResourceSnapshot snapshot) {
    ...
    assertTrue(called, "Good listener should still be called despite bad listener exception");
  }
  ...
  void testHistorySizeLimit() throws InterruptedException {
    ...
    assertTrue(
        history.getSnapshots().size() <= maxHistory,
  ...
  void testThreadTracking() throws InterruptedException {
    ...
    assertTrue(
        snapshot.getThreadCount() >= 2, "Should track at least 2 threads in the thread group");
  ...
  void testEnforcerIntegration() throws InterruptedException {
    ...
    ResourceEnforcer enforcer =
        new ResourceEnforcer(
            TEST_APP_ID, config, testThreadGroup, appId -> shutdownLatch.countDown(), appId -> {});
