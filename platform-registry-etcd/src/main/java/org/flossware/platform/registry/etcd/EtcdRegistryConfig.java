...
/**
 * Configuration for etcd-based service registry. Provides connection settings for etcd cluster and
...
public class EtcdRegistryConfig {
  ...
  /**
   * Returns the lease TTL in seconds. Service registrations expire if not renewed within this time.
   *
  ...
  /** Builder for EtcdRegistryConfig instances. Provides a fluent API for configuration. */
