...
class EtcdRegistryConfigTest {
  ...
  void testCustomEndpoint() {
    EtcdRegistryConfig config =
        EtcdRegistryConfig.builder().addEndpoint("http://etcd.example.com:2379").build();
  ...
  void testCustomLeaseTtl() {
    EtcdRegistryConfig config = EtcdRegistryConfig.builder().leaseTtl(60).build();
  ...
  void testInvalidLeaseTtl() {
    assertThrows(
        IllegalArgumentException.class, () -> EtcdRegistryConfig.builder().leaseTtl(5).build());
  }

  @Test
  void testNamespace() {
    EtcdRegistryConfig config = EtcdRegistryConfig.builder().namespace("prod").build();
