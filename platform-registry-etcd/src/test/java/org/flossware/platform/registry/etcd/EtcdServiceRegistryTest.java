...
class EtcdServiceRegistryTest {
  ...
  void testRegisterServiceNullInterface() {
    ...
    assertThrows(IllegalArgumentException.class, () -> registry.registerService(null, impl));
  }

  @Test
  void testRegisterServiceNullImplementation() {
    assertThrows(
        IllegalArgumentException.class, () -> registry.registerService(TestService.class, null));
  }
  ...
  void testStartWithLargeLeaseTtl() {
    ...
    EtcdRegistryConfig largeTtlConfig =
        EtcdRegistryConfig.builder()
  ...
  void testUnregisterWithEtcdCleanup() throws Exception {
    ...
    io.etcd.jetcd.lease.LeaseRevokeResponse revokeResponse =
        mock(io.etcd.jetcd.lease.LeaseRevokeResponse.class);
  ...
  void testGetServiceNullInterface() {
    ...
    assertThrows(IllegalArgumentException.class, () -> registry.getService(null));
  }

  @Test
  void testGetAllServicesNullInterface() {
    // Attempting to get all services with null interface should throw
    assertThrows(IllegalArgumentException.class, () -> registry.getAllServices(null));
  }
}
