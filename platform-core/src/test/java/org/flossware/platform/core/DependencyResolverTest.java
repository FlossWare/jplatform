...
/**
 * Unit tests for DependencyResolver. Tests dependency validation, startup order calculation, and
 * cycle detection.
 *
...
class DependencyResolverTest {
  ...
  void testValidateDependenciesDetectsCircularDependency() {
        ...
        ApplicationDescriptor.builder()
            ...
            .addDependency(
                new ApplicationDependency(
                    "ServiceB", ApplicationDependency.DependencyType.REQUIRED, "1.0.0"))
            .build();

    ApplicationDescriptor appB =
        ApplicationDescriptor.builder()
            .applicationId("app-b")
            ...
            .addDependency(
                new ApplicationDependency(
                    "ServiceC", ApplicationDependency.DependencyType.REQUIRED, "1.0.0"))
            .build();

    ApplicationDescriptor appC =
        ApplicationDescriptor.builder()
            .applicationId("app-c")
            ...
            .addDependency(
                new ApplicationDependency(
                    "ServiceA", ApplicationDependency.DependencyType.REQUIRED, "1.0.0"))
            .build();
    ...
    assertTrue(
        errors.stream().anyMatch(err -> err.contains("Circular dependency detected")),
  ...
  void testGetStartupOrderThrowsExceptionForCircularDependency() {
    ...
    assertTrue(
        exception.getMessage().contains("Circular dependency detected"),
  ...
  void testAddApplicationWithNullId() {
    ...
    assertThrows(IllegalArgumentException.class, () -> resolver.addApplication(null, app));
  }

  @Test
  void testAddApplicationWithNullDescriptor() {
    // Should throw exception
    assertThrows(NullPointerException.class, () -> resolver.addApplication("app1", null));
  }

  @Test
  void testRegisterServiceProviderWithNullAppId() {
    assertThrows(
        IllegalArgumentException.class, () -> resolver.registerServiceProvider(null, "ServiceA"));
  }

  @Test
  void testRegisterServiceProviderWithNullService() {
    assertThrows(
        IllegalArgumentException.class, () -> resolver.registerServiceProvider("app1", null));
  }
