...
/**
 * Unit tests for ApplicationReloader. Tests version tracking and history management.
 *
 * <p>Note: Full reload() integration tests require complex setup with ApplicationManager,
