...
class ApplicationContextImplTest {
  ...
  private ApplicationDescriptor createTestDescriptor() {
    return ApplicationDescriptor.builder().applicationId(APP_ID).mainClass("com.test.Main").build();
  }
  ...
  void testBuilderWithProperties() {
    ...
    ApplicationContextImpl context = createMinimalBuilder().properties(props).build();
  ...
  void testBuilderApplicationIdNull() {
    assertThrows(
        NullPointerException.class, () -> ApplicationContextImpl.builder().applicationId(null));
  }

  @Test
  void testBuilderDescriptorNull() {
    assertThrows(
        NullPointerException.class, () -> ApplicationContextImpl.builder().descriptor(null));
  }

  @Test
  void testBuilderClassLoaderNull() {
    assertThrows(
        NullPointerException.class, () -> ApplicationContextImpl.builder().classLoader(null));
  }

  @Test
  void testBuilderThreadPoolNull() {
    assertThrows(
        NullPointerException.class, () -> ApplicationContextImpl.builder().threadPool(null));
  }

  @Test
  void testBuilderSecurityPolicyNull() {
    assertThrows(
        NullPointerException.class, () -> ApplicationContextImpl.builder().securityPolicy(null));
  }

  @Test
  void testBuilderResourceMonitorNull() {
    assertThrows(
        NullPointerException.class, () -> ApplicationContextImpl.builder().resourceMonitor(null));
  }
  ...
  void testBuilderPropertiesNullKey() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> ApplicationContextImpl.builder().properties(props));
  }
  ...
  void testGetPropertiesIsUnmodifiable() {
    ...
    assertThrows(
        UnsupportedOperationException.class, () -> context.getProperties().put("new", "value"));
  }
  ...
  void testSetClassLoaderNull() {
    ...
    assertThrows(NullPointerException.class, () -> context.setClassLoader(null));
  }
  ...
  void testSetDescriptor() {
    ...
    ApplicationDescriptor newDescriptor =
        ApplicationDescriptor.builder().applicationId("new-app").mainClass("com.test.New").build();
  ...
  void testSetDescriptorNull() {
    ...
    assertThrows(NullPointerException.class, () -> context.setDescriptor(null));
  }
  ...
  void testSetClassLoaderAndDescriptorNullClassLoader() {
    ...
    assertThrows(
        NullPointerException.class, () -> context.setClassLoaderAndDescriptor(null, newDescriptor));
  }
