...
class ArgumentParserTest {
  ...
  void testParseArgumentsDoubleQuotedWithSpaces() {
    List<String> result =
        ArgumentParser.parseArguments("--config \"/path with spaces/config.json\" --port 8080");
  ...
  void testParseArgumentsMixedQuotedAndUnquoted() {
    List<String> result =
        ArgumentParser.parseArguments("--file \"my file.txt\" --verbose --output dir/out.log");
  ...
  void testParseArgumentsMultipleEscapeSequences() {
    List<String> result =
        ArgumentParser.parseArguments("--text \"Line1\\nLine2\\tCol\\\\Backslash\\\"Quote\"");
  ...
  void testParseArgumentsMixedDoubleAndSingleQuotes() {
    List<String> result =
        ArgumentParser.parseArguments("\"double quoted\" 'single quoted' unquoted");
  ...
  void testParseArgumentsRealWorldExample() {
    String command =
        "java -jar app.jar --config \"/etc/myapp/config.json\" --log-level INFO --data-dir \"/var/lib/myapp data\"";
