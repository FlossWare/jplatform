...
/**
 * Unit tests for ApplicationManager. Tests core lifecycle management: deploy, start, stop,
 * undeploy.
 *
...
class ApplicationManagerTest {
  ...
  void testShutdownOnEmptyManager() throws Exception {
    manager.shutdown();
    assertEquals(0, manager.listApplications().size(), "Shutdown on empty manager should succeed");
  }
  ...
  void testGetApplicationContextNullInput() {
    ...
    assertThrows(NullPointerException.class, () -> manager.getApplicationContext(null));
  }
