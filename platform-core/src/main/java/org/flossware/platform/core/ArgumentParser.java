 ...
 *
 * <p>Handles quoted strings, allowing arguments to contain spaces:
 *
 * <pre>{@code
...
class ArgumentParser {
   ...
   *
   * <p>Supports both double quotes ("...") and single quotes ('...'). Quoted strings can contain
   * spaces, which will be preserved as single arguments. Unquoted sequences are split by
   * whitespace.
   *
  ...
  /**
   * Unescapes backslash sequences in a string. Converts \" to ", \' to ', \\ to \, etc.
   *
