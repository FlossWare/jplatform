 ...
 *
 * <p>Extracts key characteristics from an {@link ApplicationDescriptor} that
 * influence placement decisions:</p>
 * <ul>
 *   <li>Workload type (Java, native, container image)</li>
 *   <li>Resource requirements (CPU, memory, disk)</li>
 *   <li>Isolation requirements (kernel access, security policies)</li>
 *   <li>Scale requirements (replica count, auto-scaling)</li>
 * </ul>
 *
 * <p>Example usage:</p>
 * <pre>{@code
...
public final class WorkloadProfile {
     ...
     *
     * <p>Workloads requiring kernel access must run in a VM or on bare metal,
     * not in containers or in-JVM isolation.</p>
     *
     ...
     *
     * <p>This is a policy override that forces VM placement regardless
     ...
     *
     * <p>A workload is considered lightweight if:</p>
     * <ul>
     *   <li>It's a Java application</li>
     *   <li>Memory requirement is below 4GB</li>
     *   <li>No kernel access required</li>
     *   <li>No explicit VM isolation required</li>
     * </ul>
     *
     ...
     *
     * <p>A workload is considered heavy if:</p>
     * <ul>
     *   <li>Memory requirement is 16GB or more</li>
     *   <li>CPU requirement is 8 cores or more</li>
     * </ul>
     *
     ...
     *
     * <p>Massive scale is defined as requiring 10 or more replicas.</p>
     *
    ...
    @Override
    public int hashCode() {
        return Objects.hash(isJavaApp, isNativeApp, isContainerImage, cpuCores, memoryMB,
                needsKernelAccess, requiresVmIsolation, requiredReplicas, applicationId);
    }
    ...
    public String toString() {
        ...
        sb.append(", cpu=").append(cpuCores)
          .append(", memory=").append(memoryMB).append("MB")
          .append(", replicas=").append(requiredReplicas);
