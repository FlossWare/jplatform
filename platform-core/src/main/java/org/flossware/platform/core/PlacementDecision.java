 ...
 *
 * <p>Contains the selected execution backend and the rationale for the decision.
 * This information is used for observability, debugging, and policy validation.</p>
 *
 * <p>Example usage:</p>
 * <pre>{@code
...
public final class PlacementDecision {
     ...
     */
    public PlacementDecision(String applicationId, ExecutionBackend backend, String reason, long timestamp) {
     ...
     *
     * <p>The reason explains why this particular backend was selected,
     * useful for debugging, auditing, and policy validation.</p>
     *
     * <p>Example reasons:</p>
     * <ul>
     *   <li>"Lightweight Java app (512MB memory)"</li>
     *   <li>"Heavy Java app requires container isolation"</li>
     *   <li>"Non-Java workload requires VM"</li>
     *   <li>"High replica count (50) requires Kubernetes"</li>
     *   <li>"Policy override: financial apps require VM isolation"</li>
     * </ul>
     *
    ...
    public String toString() {
        ...
        sb.append("backend=").append(backend.getId())
