 ...
 *
 * <p>This layout extends PatternLayout to automatically redact sensitive information such as API
 * keys, passwords, tokens, and other credentials from log output.
 *
 ...
 * }</pre>
 *
 * <p><strong>Security Note:</strong> This class provides defense-in-depth for logging. Applications
 * should still avoid logging sensitive data in the first place.
 *
 * @since 2.0
 */
public class MaskingPatternLayout extends PatternLayout {
   ...
   *
   * <p>The pattern should contain at least one capture group. The first capture group will be
   * replaced with REDACTED. If no capture groups are present, the entire match is replaced.
   *
