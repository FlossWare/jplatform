...
/**
 * Configuration for Vault-based configuration source. Provides connection settings for HashiCorp
 * Vault and configuration parameters.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class VaultConfigSourceConfig {
  ...
  /** Builder for VaultConfigSourceConfig instances. Provides a fluent API for configuration. */
