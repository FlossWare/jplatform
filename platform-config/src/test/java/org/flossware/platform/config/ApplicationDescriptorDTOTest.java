...
class ApplicationDescriptorDTOTest {
  ...
  void testMissingApplicationId() throws Exception {
    ...
    ParseException ex = assertThrows(ParseException.class, () -> dto.toApplicationDescriptor());
  ...
  void testInvalidClasspathURI() throws Exception {
    String json =
        "{\"applicationId\":\"test-app\",\"mainClass\":\"com.example.Main\","
  ...
  void testThreadPoolConfigFull() throws Exception {
    String json =
        "{\"corePoolSize\":5,\"maxPoolSize\":20,\"keepAliveTimeSeconds\":60,\"queueCapacity\":100}";

    ApplicationDescriptorDTO.ThreadPoolConfigDTO dto =
        mapper.readValue(json, ApplicationDescriptorDTO.ThreadPoolConfigDTO.class);
  ...
  void testSecurityConfigMinimal() throws Exception {
    ...
    ApplicationDescriptorDTO.SecurityConfigDTO dto =
        mapper.readValue(json, ApplicationDescriptorDTO.SecurityConfigDTO.class);
  ...
  void testSecurityConfigWithSocketPermissions() throws Exception {
    String json =
        "{\"socketPermissions\":[{\"host\":\"localhost:8080\",\"actions\":\"connect,resolve\"}]}";
  ...
  void testSecurityConfigNullFilePermissionEntry() throws Exception {
    ...
    ParseException ex = assertThrows(ParseException.class, () -> dto.toSecurityConfig());
  ...
  void testResourceConfigMinimal() throws Exception {
    ...
    ApplicationDescriptorDTO.ResourceConfigDTO dto =
        mapper.readValue(json, ApplicationDescriptorDTO.ResourceConfigDTO.class);
