 ...
 * from external configuration formats (YAML/JSON) to domain objects.
 *
 * <p>This DTO uses Jackson annotations to deserialize external configuration and provides
 * conversion logic to create immutable ApplicationDescriptor instances using builders.
 *
...
public class ApplicationDescriptorDTO {
   ...
   * @throws ParseException if conversion fails (e.g., invalid URI syntax or missing required
   *     fields)
   */
