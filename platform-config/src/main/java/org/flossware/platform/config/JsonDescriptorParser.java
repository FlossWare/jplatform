...
/**
 * Parser for loading ApplicationDescriptor from JSON configuration files. Uses Jackson's
 * ObjectMapper to deserialize JSON content into ApplicationDescriptor objects.
 *
 * <p>This parser supports standard JSON syntax and maps configuration elements to the
 ...
 * @see org.flossware.platform.api.ApplicationDescriptor
 */
public class JsonDescriptorParser extends AbstractDescriptorParser {

  /**
   * Constructs a new JSON descriptor parser. Initializes the parser with a standard ObjectMapper
   * for processing JSON content.
   */
  ...
  /**
   * Creates a standard ObjectMapper for parsing JSON content. Configured to use private fields
