...
/**
 * Configuration for Consul-based configuration source. Provides connection settings for Consul
 * agent and configuration parameters.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class ConsulConfigSourceConfig {
  ...
  /** Builder for ConsulConfigSourceConfig instances. Provides a fluent API for configuration. */
