...
/**
 * Simple token bucket implementation for rate limiting. Thread-safe implementation using atomic
 * operations.
 *
 * <p>The token bucket algorithm allows bursts up to the capacity while maintaining an average rate
 * over time.
 *
 * @since 1.1
 */
