...
/**
 * Configuration for Netty-based REST API server. Provides server settings and configuration
 * parameters.
 *
 * <p>Example usage:
 *
...
public class NettyApiServerConfig {
  ...
  /** Builder for NettyApiServerConfig instances. Provides a fluent API for configuration. */
